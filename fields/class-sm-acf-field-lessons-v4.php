...
if( !class_exists('sm_acf_field_lessons') ) :


class sm_acf_field_lessons extends acf_field {
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Preview Size",'saibamais'); ?></label>
		<p class="description"><?php _e("Thumbnail is advised",'saibamais'); ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'thumbnail' => __('Thumbnail', 'saibamais'),
				'something_else' => __('Something Else', 'saibamais'),
			)
		));
...
// initialize
new sm_acf_field_lessons( $this->settings );
